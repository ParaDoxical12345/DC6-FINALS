...
.light-button {
  background-color: #3f3c3c; /* White color for light mode */
  color: #fff;
  transition-duration: 0.5s;
}
...
<template>
    ...
    <div id="app" class="flex flex-col min-h-screen">
        <div class="flex flex-1 min-h-screen">
            <div class="bg-gray-600 text-white w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out " :class="width" >
            ...
            >
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between h-16">
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                ...
                                <span @click="toggleDarkMode" :class="themeMode === 'dark' ? 'dark-button' : 'light-button'" class="absolute bottom-4 right-4 h-8 w-8 bg-white-500 rounded-full inline-flex items-center justify-center hover:bg-white-600">
                ...
                <footer class=" footer footer-center text-center p-4 bg-base-300 text-base-content" :class="themeMode">
                    <aside>
                      <p class="text-center">© 2023 Habibi Apple Store. All rights reserved.</p>
                    </aside>
                  </footer>
              </div>
        </div>
